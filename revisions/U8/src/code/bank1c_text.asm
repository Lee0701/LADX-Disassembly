...
.handleNameChar
    ...
    call UTF16BE_to_UTF32.dialog_name
    call GetFontAddr
    jr .endChar
...
.jp_27AA
    ...
    ld   hl, wFarcallParams                       ; $5498: $21 $01 $DE
    ld   a, BANK(DrawDialogChoiceMarker)                   ; $549B: $3E $21
    ld   [hl+], a                                 ; $549D: $22
    ld   a, HIGH(DrawDialogChoiceMarker)                   ; $549E: $3E $53
    ld   [hl+], a                                 ; $54A0: $22
    ld   a, LOW(DrawDialogChoiceMarker)                    ; $54A1: $3E $B6
    ld   [hl+], a                                 ; $54A3: $22
    ld   a, BANK(@)                               ; $54A4: $3E $14
    ld   [wFarcallReturnBank], a                  ; $54A6: $EA $04 $DE
    jp   Farcall                                  ; $54A9: $C3 $D7 $0B
...
DrawDialogArrowTrampoline::
    ...
    ld   hl, wFarcallParams                       ; $5498: $21 $01 $DE
    ld   a, BANK(DrawDialogArrow)                   ; $549B: $3E $21
    ld   [hl+], a                                 ; $549D: $22
    ld   a, HIGH(DrawDialogArrow)                   ; $549E: $3E $53
    ld   [hl+], a                                 ; $54A0: $22
    ld   a, LOW(DrawDialogArrow)                    ; $54A1: $3E $B6
    ld   [hl+], a                                 ; $54A3: $22
    ld   a, BANK(@)                               ; $54A4: $3E $14
    ld   [wFarcallReturnBank], a                  ; $54A6: $EA $04 $DE
    jp   Farcall                                  ; $54A9: $C3 $D7 $0B
